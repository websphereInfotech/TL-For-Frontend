    ...
    <>
      <div className='px-10 container mx-auto'>
        ...
        <Row className='lg:pl-12 xl:pl-12 lg:pr-10 px-0 d-flex justify-center'>
          <Col lg={4} md={6} sm={12} className='my-10 p-0 rounded-md text-white' style={{ position: 'relative' }}>
            <div className=''>
            <img src={require('../../Images/timberland3.avif')} alt='' style={{height:'500px',width:'500px'}} />
            </div>
          ...
          <Col lg={4} md={6} sm={12} className=' md:my-32'>
            ...
            <p className='text-xl xl:text-4xl md:text-3xl mb-4 font-bold text-center md:ml-12 xl:ml-14 color'>Welcome,back!<span className='text-2xl'>{emoji}</span></p>
            </div>
            <Form className='w-50 md:w-72 sm:w-96 mx-auto ' onSubmit={handleSubmit} >
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label className='font-bold color'>Login Id
              ...
              <Form.Group className="mb-3" controlId="formBasicPassword">
                <Form.Label className='font-bold color'>Password
                  <span className='text-red-600'> &#8727; </span>
                  :</Form.Label>
                <Form.Control
                  type="password"
              ...
              <input type="submit" value="Login" className='btn n-color text-white w-full  md:mx-1 sm:mx-0 border-1 py-1'  />
            </Form>
          </Col>
        </Row>
        </div>
